...
// abrir mascota desde sala de espera
const openPet = JSON.parse(localStorage.getItem("openPet"));

if(openPet){

setTimeout(()=>{

loadPet(openPet.clienteIndex, openPet.mascotaIndex);

localStorage.removeItem("openPet");
